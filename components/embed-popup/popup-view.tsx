        ...
        {!sessionStarted && (
          ...
          >
            <motion.div
              ...
              transition={{ delay: 0.05, type: 'spring', bounce: 0.35, duration: 0.7 }}
              className="bg-fgAccent/10 ring-fgAccent/20 mb-6 grid size-20 place-items-center rounded-full ring-8"
            >
              {appConfig.logo ? (
            ...
            <motion.h2
              ...
              className="text-fg0 mb-2 text-lg font-semibold"
            >
              {appConfig.companyName
                ? `Chat with ${appConfig.companyName}`
            ...
            <motion.p
              ...
              className="text-fg1 mb-8 max-w-[260px] text-sm"
            >
              Tap below to start a live voice conversation. We&apos;ll ask for microphone access.
            </motion.p>
            <motion.div
              initial={{ y: 8, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              <Button
                ...
                className="shadow-fgAccent/20 shadow-lg"
              >
